...
class SEBlock(nn.Module):
    """Squeeze-and-Excitation cho decoder để tăng độ phân biệt kênh."""
...
class Network(nn.Module):
    def __init__(self, num_keypoints: int = 21, pretrained: bool = True):
        ...
        super().__init__()
        # Dùng backbone ResNet18 nhẹ hơn (như mô hình bạn ưa thích trước đây)
        weights = (
        ...
        self.enc3 = resnet.layer2  # (B, 128, 23, 40)
        self.enc4 = resnet.layer3  # (B, 256, 12, 20)
